...
brew install git git-credential-manager fzf bat ripgrep stow starship tmux zsh-autosuggestions zsh-syntax-highlighting sk fd fastfetch gcc uv spotify gh
